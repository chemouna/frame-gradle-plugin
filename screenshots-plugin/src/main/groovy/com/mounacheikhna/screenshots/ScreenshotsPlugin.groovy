...
class ScreenshotsPlugin implements Plugin<Project> {
  ...
  void apply(Project project) {
    ...
    screenshotsTask.description =
        "Takes screenshots generated by spoon on all the connected devices for variation and copies them into play folder each in the right place."
